...
def main():
    ...
    pretrained_path = '/home/umcg/Desktop/AutomaticITV_code/testUMCGx2/best_m_MONAI_V3_UMCGWeightsretrainedWithUMCGdata_X2RetrainedwithAITVdata.pth'
    ...
    with torch.no_grad():
        for val_data in val_loader:
            ...
            #compute metric for current iteration
            dice_metric(y_pred=val_outputs[0], y=val_labels[0])
