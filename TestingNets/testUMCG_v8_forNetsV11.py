...
if __name__ == "__main__":
    ...
    ####TEST SET 3
    SelectModel = 1  # 0 Swin  - 1 Dyn
    figures_folder_i = figures_path + 'figures_DynU_v10_5/'
    pretrained_path = preweight_path + 'best_DynUnet_V10_TestSet3.pth'
    name_run = "NameRun Dyn" + str(SelectModel) + "LF" + str(lf_select) + "run0"
    print(name_run)
    main(SelectModel, figures_folder_i, name_run, pretrained_path, cache, num_workers, root_path)

    SelectModel = 0  # 0 Swin  - 1 Dyn
    figures_folder_i = figures_path + 'figures_SU_v10_5/'
    pretrained_path = preweight_path + 'best_SwinUnet_V10_TestSet3.pth'
    print('LF is ', lf_select, ' Db is UMCG')
    name_run = "NameRun Swin" + str(SelectModel) + "LF" + str(lf_select) + "run0"
    print(name_run)
    main(SelectModel, figures_folder_i, name_run, pretrained_path, cache, num_workers, root_path)
