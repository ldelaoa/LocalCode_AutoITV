        ...
        with torch.no_grad():
            ...
            if metric > best_metric:
                ...
                torch.save(model.state_dict(), os.path.join(
                    root_path, "best_SwinUnet_V9_NBIA_Loss"+str(lf_select)+".pth"))
...
def main(lf_select,cache,num_workers,root_path):
    ...
    train_files, val_files = data_dicts[:], data_dicts[-25:]
    ...
    #pretrained_path = '/data/p308104/NBIA_Data/NIFTI_NBIA/imagesTr/best_MONAI_V8_NBIA_Loss2.pth'
    ...
    weights_path = '/home/p308104/jobs/model_swinvit.pt'
    #weights_path = None
    ...
    scheduler = torch.optim.lr_scheduler.CosineAnnealingWarmRestarts(optimizer=optimizer, T_0=T_0,T_mult=1, eta_min=1e-9)#1e-8
    #metrics
    dice_metric = DiceMetric(include_background=False, reduction="mean",get_not_nans=False)
    
    wandb.init(project="UMCG_V9", entity="ldelaoa",name="run_1 Loss2")
    wandb.config = {
      "learning_rate": lr,
      "epochs": max_epochs,
      "batch_size": 2,
...
if __name__ == "__main__":
    ...
    cache=True
    lf_select =2
    print('LF is ',lf_select,'Db is UMCG','w Weights')
    main(lf_select,cache,num_workers,root_path)
...
# 3- NBIA name of proyect now is UMCG_V9
