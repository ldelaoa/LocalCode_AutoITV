        ...
        with torch.no_grad():
            ...
            if metric > best_metric:
                ...
                torch.save(model.state_dict(), os.path.join(
                    root_path, "best_UnetR_V9_NBIA_Loss"+str(lf_select)+".pth"))
...
def main(name_run,lf_select,cache,num_workers,root_path):
    ...
    while (epoch < max_epochs) and (epoch - best_metric_epoch >= epoch_early_stopping):
...
if __name__ == "__main__":
    ...
    name_run = "UnetR"+"LF"+str(lf_select)+"run1"
